...
public class FrmRecupera extends javax.swing.JFrame {
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        ControllerLogintxt cnttxt = new ControllerLogintxt();
            ...
            if (txtRepetirContra.getText() == txtNuevaContra.getText()) {
                String email = txtUsuario.getText();
                String n_clave = txtNuevaContra.getText();

                cnt.recuperarClave(email, n_clave);
                cnttxt.recuperarClave(email, n_clave);
            } else {
